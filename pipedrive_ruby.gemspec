...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Ruby gem for use Pipedrive API.}
  spec.description   = %q{Make a wrapper for call Pipedrive API with the power of multi accounts call and parse custom fields}
